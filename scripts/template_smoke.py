...
def assert_generated_variables(generated: Path) -> None:
    ...
    assert_contains(generated / "00-START-HERE.md", "uv run poe agent-handoff-clean")
    ...
    assert_contains(generated / "00-START-HERE" / "README.md", "uv run poe agent-handoff-clean")
    ...
    assert_contains(generated / "PROJECT_MAP.md", "uv run poe agent-handoff-clean")
    ...
    assert_contains(generated / "README.md", "uv run poe agent-handoff-clean")
    ...
    assert_contains(generated / "AGENTS.md", "uv run poe agent-handoff-clean")
