...
def assert_generated_variables(generated: Path) -> None:
    ...
    assert_contains(generated / "00-START-HERE.md", "uv run poe agent-handoff")
    ...
    assert_contains(generated / "00-START-HERE" / "README.md", "uv run poe agent-handoff")
    ...
    assert_contains(generated / "PROJECT_MAP.md", "uv run poe agent-handoff")
    ...
    assert_contains(generated / "README.md", "## AI Agent Entry")
    assert_contains(generated / "README.md", "Read [PROJECT_MAP.md](PROJECT_MAP.md)")
    assert_contains(generated / "README.md", "Read [AGENTS.md](AGENTS.md)")
    assert_contains(generated / "README.md", "Run `uv run poe agent-start`")
    assert_contains(generated / "README.md", "uv run poe agent-handoff")
    ...
    assert_contains(generated / "AGENTS.md", "uv run poe agent-handoff")
    ...
    assert_contains(generated / "AGENTS.md", "Do not hand work to an agent on the baseline branch.")
    assert_contains(
        generated / "AGENTS.md",
